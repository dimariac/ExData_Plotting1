...
png(filename="plot4.png", width=480, heigh=480) ## Open png device

# Do plot...
par(mfrow=c(2,2)) ## Initialise new plot.

# Subplot 1: datetime vs Global Active Power
plot(datetime, data$Global_active_power, type="l",
     xlab="", ylab="Global Active Power")

# Subplot 2: datetime vs Voltage
plot(datetime, data$Voltage, type="l",
     xlab="datetime", ylab="Voltage")

# Subplot 3: datetime vs Energy sub metering
...
# Subplot 4: datetime vs Global_reactive_power
